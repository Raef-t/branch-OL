...
import { useGetStudentsForReportQuery, useLazyGenerateStudentDataReportQuery } from "@/store/services/reportsApi";
...
export default function StudentsDataPage() {
  ...
  const [triggerGenerate, { data: reportRes, isFetching: generating }] = useLazyGenerateStudentDataReportQuery();
        ...
        <div className="flex justify-between items-center flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <ActionsRow
              ...
              onToggleSelectAll={() =>
                setSelectedIds(
                  isAllSelected ? [] : reportData.map((s) => s.id),
                )
              }
              addLabel=""
              viewLabel=""
