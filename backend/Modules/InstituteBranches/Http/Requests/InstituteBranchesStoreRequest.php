...
class InstituteBranchesStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code'         => 'required|string|max:50|unique:institute_branches,code',
    ...
    public function messages(): array
    {
        return [
            ...
            'country_code.max'    => 'كود الدولة يجب ألا يتجاوز 5 رموز.',
