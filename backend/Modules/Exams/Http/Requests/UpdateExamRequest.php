...
class UpdateExamRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'exam_time' => 'sometimes|required|date_format:H:i',
            'exam_end_time' => 'sometimes|required|date_format:H:i|after:exam_time',
            'total_marks' => 'sometimes|required|integer|min:1',
            'passing_marks' => 'sometimes|required|integer|min:0|lte:total_marks',
