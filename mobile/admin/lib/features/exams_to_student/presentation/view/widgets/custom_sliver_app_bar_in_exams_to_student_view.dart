...
class CustomSliverAppBarInExamsToStudentView extends StatelessWidget {
  const CustomSliverAppBarInExamsToStudentView({super.key});
  ...
  Widget build(BuildContext context) {
    return const SliverAppBarToHoleAppComponent(
      appBarWidget: AppBarWidgetWithRightArrowImageAndThreeTextsComponent(
        firstText: 'المذاكرات',
        secondText: 'يمكنك الاطلاع على جميع مذاكرات التي',
        thirdText: 'تقدم في هذا اليوم',
      ),
    );
  }
}
