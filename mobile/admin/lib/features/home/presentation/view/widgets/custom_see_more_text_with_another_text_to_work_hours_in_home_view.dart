...
class CustomSeeMoreTextWithAnotherTextToWorkHoursInHomeView
    extends StatelessWidget {
  const CustomSeeMoreTextWithAnotherTextToWorkHoursInHomeView({super.key});

  @override
  Widget build(BuildContext context) {
    return OnlyPaddingWithChild.left19AndRight21(
      context: context,
      child: SeeMoreTextAndAnotherTextComponent(
        text: 'برنامج الدوام',
        onTap: () =>
            pushGoRouterHelper(context: context, view: kWorkHoursViewRouter),
