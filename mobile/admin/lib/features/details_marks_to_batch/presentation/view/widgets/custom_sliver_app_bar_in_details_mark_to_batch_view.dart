...
class CustomSliverAppBarInDetailsMarkToBatchView extends StatelessWidget {
  const CustomSliverAppBarInDetailsMarkToBatchView({super.key});
  ...
  Widget build(BuildContext context) {
    return const SliverAppBarToHoleAppComponent(
      appBarWidget: AppBarWidgetWithRightArrowImageAndThreeTextsComponent(
        firstText: 'نتائج',
        secondText: 'يمكنك الاطلاع على جميع علامات الطلاب في',
        thirdText: 'هذه المادة',
      ),
    );
  }
}
