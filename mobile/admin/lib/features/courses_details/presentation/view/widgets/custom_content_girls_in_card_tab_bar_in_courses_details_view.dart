...
import '/features/courses_details/presentation/view/widgets/custom_success_state_for_girl_in_courses_details_view.dart';

class CustomContentGirlsInCardTabBarInCoursesDetailsView
    extends StatefulWidget {
  const CustomContentGirlsInCardTabBarInCoursesDetailsView({
    super.key,
    required this.academicBranchesModel,
  });
  final AcademicBranchesToCoursesModel academicBranchesModel;
  @override
  State<CustomContentGirlsInCardTabBarInCoursesDetailsView> createState() =>
      _CustomContentGirlsInCardTabBarInCoursesDetailsViewState();
}

class _CustomContentGirlsInCardTabBarInCoursesDetailsViewState
    extends State<CustomContentGirlsInCardTabBarInCoursesDetailsView> {
  @override
  void initState() {
    ...
    >(
      builder: (context, state) {
        if (state is AcademicBranchesSuccessCoursesDetailsState) {
          ...
          return CustomSuccessStateForGirlInCoursesDetailsView(
